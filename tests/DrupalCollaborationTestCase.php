...
abstract class DrupalCollaborationTestCase extends DrupalTestCase {
  ...
  protected function assert($status, $message = '', $group = 'Other', array $caller = NULL) {
    return $this->leader()->doAssert($status, $message, $group, $caller); // TODO: Change the autogenerated stub
  }

  /**
   * Actually performs an assert.
   */
  public function doAssert($status, $message, $group, $caller) {
  ...
  public function run() {
    if (!empty($this->leader) && $this->leader !== $this) {
      throw new \LogicException('Can only run the test if we are the leader, or leader has yet to be designated.');
    }
